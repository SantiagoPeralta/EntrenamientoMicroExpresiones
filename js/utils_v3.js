...
function updateTrialInfo(state) {
    ...
    if (state.currentSubject) {
        ...
        // Mostrar el ángulo actual SIEMPRE
        let angleText = getAngleDescription(state.currentAngle);
        
        // Si es nivel fácil, aseguramos que se muestre como frontal
        ...
        infoDiv.innerHTML = `
            <div class="d-flex justify-content-center">
                <div class="badge-container">
                    ...
                    <span><i class="bi bi-arrows-angle-expand"></i> ${angleText}</span>
                    <span><i class="bi bi-arrow-left-right"></i> ${state.currentPosition === 'L' ? 'Izquierda' : 'Derecha'}</span>
                </div>
            </div>
